...
export default {
  ...
  component: Components.Global.ResponsiveTable,
};

const Template: ComponentStory<typeof Components.Global.ResponsiveTable> = (
  args
) => <Components.Global.ResponsiveTable {...args} />;
